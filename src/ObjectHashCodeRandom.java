...
public class ObjectHashCodeRandom {
	...
	public void createDistributionArrayCSV() {
		...
		try {
			FileWriter fileWriter = new FileWriter("objectHashCodeRandom.csv");
	...
	public void createBitMap() {
		...
		try {
			File objectHashCodeRandomBitMap = new File("objectHashCodeRandomBitMap.jpg");
			ImageIO.write(bitMap, "jpg", objectHashCodeRandomBitMap);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void analyze() {
		System.out.println("##############################");
		System.out.println("## OBJECT HASH CODE RANDOM ###");
		System.out.println("##############################");
	...
	private void generateRandomNumbers() {
		for (int i = 0; i < sequenceArray.length; i++) {
			...
			int randomNumber = objectHashCode % distributionArray.length;
